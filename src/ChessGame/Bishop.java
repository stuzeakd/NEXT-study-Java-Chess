...
public class Bishop extends Piece {
	...
	public Bishop(char file, char rank, EPlayerColor color) {
		super(file, rank, color);
		_attackDirs = EnumSet.of(EDirection.UPLEFT, EDirection.UPRIGHT, EDirection.DOWNLEFT, EDirection.DOWNRIGHT);
		
		// TODO Auto-generated constructor stub
	}

	@Override
	public EPieceType GetType() { return EPieceType.BISHOP; }
